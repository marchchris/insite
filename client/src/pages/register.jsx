                ...
                <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4 mt-5">
                    <div class="max-w-md w-full">
                        <div class="p-8 rounded-2xl bg-white bg-opacity-5">
                            <h2 class="text-white text-center 2xl:text-2xl text-lg font-bold">Create Account</h2>
                            <form class="mt-8 space-y-4" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input maxLength="200" name="password" type="password" required class="w-full bg-white bg-opacity-5 text-neutral-300 2xl:text-sm text-xs border border-white border-opacity-15 px-4 py-3 rounded-md focus:outline-none" placeholder="Enter password" />
                                    </div>
                                </div>

                                <div>
                                    <label class="text-white 2xl:text-sm text-xs mb-2 block">Confirm Password</label>
                                    <div class="relative flex items-center">
                                        <input maxLength="200" name="confirmPassword" type="password" required class="w-full bg-white bg-opacity-5 text-neutral-300 2xl:text-sm text-xs border border-white border-opacity-15 px-4 py-3 rounded-md focus:outline-none" placeholder="Enter password" />
                                    </div>
                                </div>
                                ...
                                <p class="text-white 2xl:text-sm text-xs !mt-8 text-center">Already have an account? <a href="/login" class="text-purple-300 hover:underline ml-1 whitespace-nowrap font-semibold ">Login here</a></p>
                            </form>
                        </div>
                    </div>
                </div>
