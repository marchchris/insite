    ...
    return (
        <div className="flex flex-row w-screen h-screen bg-[#2a2a2a] overflow-hidden">
            ...
            <div className="flex flex-col w-full overflow-hidden">
                ...
                {/* Main Area */}
                <div className="flex-1 overflow-y-auto bg-[#2a2a2a] 2xl:p-8 p-4">
                    {/* Overview Page */}
                    {currentPage === "Overview" && (
                        ...
                        <div className="flex flex-col w-full h-full bg-[#2a2a2a]">
                            <div className="flex w-full h-1/6 justify-center items-center">
                                <article
                                    className="flex items-end justify-between rounded-xl bg-white bg-opacity-5 2xl:p-10 p-5 w-1/4 mx-4"
                                >
                                    <div>
                                        <p className="text-sm text-white">Feedback Received</p>
                                        <p className="text-xs text-white opacity-40">Last 7 Days</p>

                                        <p className="2xl:text-2xl text-lg font-medium text-white">{feedbackStats.received}</p>
                                    </div>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="2xl:text-2xl text-lg font-medium text-white">{feedbackStats.positive}</p>
                                    </div>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="2xl:text-2xl text-lg font-medium text-white">{feedbackStats.negative}</p>
                                    </div>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="2xl:text-2xl text-lg font-medium text-white">{resolvedNumber}</p>
                                    </div>
                                </article>
                            ...
                            <div className="flex w-full h-5/6 justify-center items-center 2xl:mt-10 mt-5">
                                ...
                                <div className="flex flex-row w-full h-full px-4 gap-8">
                                    <div className="flex flex-col w-4/6 h-full p-8 bg-white bg-opacity-5 rounded-xl">
                                        <h1 className=" text-white font-semibold 2xl:text-base text-sm">Feedback Received Per Month</h1>
                                    ...
                                    <div className="flex flex-col w-2/6 h-full rounded-xl bg-white bg-opacity-5 p-8">
                                        <h1 className="text-white font-semibold 2xl:text-base text-sm">Current Feedback Pending</h1>
                                        <p className="text-xs text-white opacity-40 ">All Time</p>
                                            ...
                                            <div className="flex w-1/3 h-full justify-center items-center">
                                                <ul className="space-y-3">
                                                    <li className="flex items-center">
                                                        ...
                                                        <span className="text-white 2xl:text-base text-sm">Positive</span>
                                                    </li>
                                                    <li className="flex items-center">
                                                        <span className="w-3 h-3 bg-red-500 rounded-full mr-2"></span>
                                                        <span className="text-white 2xl:text-base text-sm">Negative</span>
                                                    </li>
                                                    <li className="flex items-center">
                                                        <span className="w-3 h-3 bg-yellow-500 rounded-full mr-2"></span>
                                                        <span className="text-white 2xl:text-base text-sm">Neutral</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    {currentPage === "Feedback" && (
                        ...
                        <div className="flex flex-col w-full h-full bg-[#2a2a2a] ">
                            ...
                            <div className="flex flex 2xl:w-5/6 w-full h-full m-auto justify-center">
                                        ...
                                        <table className="min-w-full divide-y-2 divide-white divide-opacity-15 text-sm">
                                            <thead className="text-left text-white">
                                                <tr>
                                                    ...
                                                    <th className="px-4 py-2 font-medium whitespace-nowrap 2xl:text-base text-xs">Name</th>
                                                    <th className="px-4 py-2 font-medium whitespace-nowrap 2xl:text-base text-xs">Email</th>
                                                    <th className="px-4 py-2 font-medium whitespace-nowrap 2xl:text-base text-xs">Category</th>
                                                    <th className="px-4 py-2 font-medium whitespace-nowrap 2xl:text-base text-xs">Date Submitted</th>
                                                    <th className="px-4 py-2 font-medium whitespace-nowrap 2xl:text-base text-xs">Rating</th>
                                            ...
                                            <tbody className="divide-y divide-white divide-opacity-15">
                                                ...
                                                {filteredFeedbackData.length === 0 && (
                                                    <tr>
                                                        <td colSpan="6" className="text-center text-white opacity-40 py-4 2xl:text-base text-xs">You have no current feedback</td>
                                                    </tr>
                                                )}
                                                {filteredFeedbackData.map((data, index) => (
                                                    <tr key={index} className=" cursor-pointer hover:bg-white hover:bg-opacity-10 transition duration-300" onClick={(event) => handleRowClick(data, event)}>
                                                        ...
                                                        <td className="px-4 py-2 whitespace-nowrap text-white font-semibold 2xl:text-base text-xs">{data.name}</td>
                                                        <td className="px-4 py-2 whitespace-nowrap text-white opacity-60 2xl:text-base text-xs">{data.email}</td>
                                                        <td className="px-4 py-2 whitespace-nowrap">
                                                            <div className={`inline-block py-1 px-3 rounded-full font-semibold 2xl:text-base text-xs ${data.category === "Bug" ? "bg-red-500 text-red-100" : data.category === "Design" ? "bg-blue-500 text-blue-100" : data.category === "Feature" ? "bg-green-500 text-green-100" : "bg-yellow-500 text-yellow-100 "}`}>
                                                                {data.category}
                                                            </div>
                                                        </td>
                                                        <td className="px-4 py-2 whitespace-nowrap text-white opacity-60 2xl:text-base text-xs">
                                                        ...
                                                        <td className="px-4 py-2 whitespace-nowrap text-white">
                                                            <div className="flex flex-col items-center">
                                                                ...
                                                                <div className="w-full bg-white bg-opacity-10 rounded-full h-2.5 2xl:text-base text-xs">
                        ...
                        <div className="flex flex-col w-full h-full bg-[#2a2a2a]">
                            <div className="flex m-auto">
                                <div className="flex flex-col w-full bg-white bg-opacity-5 rounded-xl p-8 justify-center items-center">
                                    <h2 className="text-white 2xl:text-xl text-lg font-bold">Your Public Key</h2>
                                    <p className="text-white opacity-60 mt-4 2xl:text-sm text-xs">Use this API key to integrate the feedback form into your website.</p>
                                    ...
                                    <div className="inline flex items-center gap-1 w-full">
                                        <div className="rounded-lg p-4 font-mono text-sm w-full flex justify-center items-center">
                                            <pre className="text-white overflow-x-auto w-full bg-neutral-700 2xl:p-4 p-2 rounded-lg text-center 2xl:text-base text-sm">
                                                {userData.apiKey}
                                            </pre>
                                        </div>
                                        <button
                                            onClick={() => navigator.clipboard.writeText(userData.apiKey)}
                                            className="px-4 w-1/2 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition duration-300 flex items-center gap-2  2xl:text-base text-sm"
                                        >
                                    ...
                                    <div className="mt-4 w-full flex flex-col justify-center items-center">
                                        <h3 className="text-white 2xl:text-lg text-base font-medium mb-2 text-center">Implementation Example</h3>
                                    ...
                                    <div className="w-full flex flex-col justify-center items-center">
                                        <h3 className="text-white 2xl:text-lg text-base font-medium mb-2 text-center">See Your Form Live</h3>
                                        <p className="text-white opacity-60 mb-4 font-medium 2xl:text-sm text-xs">
                                        ...
                                        <button
                                            ...
                                            className="px-4 w-1/2 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition duration-300 flex items-center justify-center gap-2 2xl:text-base text-sm"
                                        >
                                            Go To Form
                        ...
                        <div className="flex flex-col w-full h-full bg-[#2a2a2a]">
                            <div className="flex w-full h-fit m-auto gap-2 justify-center">
                                ...
                                <div className="flex flex-col w-1/3 h-fit bg-white bg-opacity-5 rounded-xl p-8">
                                    <h2 className="text-white 2xl:text-xl text-lg font-bold mb-6">Form Customisation</h2>
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center justify-between">
                                            <label className="text-white 2xl:text-base text-sm">Theme</label>
                                            <div className="flex items-center gap-2">
                                                <span className="text-white opacity-70 2xl:text-sm text-xs">
                                        ...
                                        <div>
                                            <label className="block text-white mb-2 2xl:text-base text-sm">Form Title</label>
                                            <input
                                                type="text"
                                                maxLength = "64"
                                                ...
                                                className="w-full p-2 rounded bg-neutral-700 text-white border border-neutral-600 focus:border-purple-500 focus:outline-none 2xl:text-base text-sm"
                                            />
                                        </div>

                                        <div>
                                            <label className="block text-white mb-2 2xl:text-base text-sm">Form Description</label>
                                            <textarea
                                        ...
                                        <div className="flex justify-end">
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded ${isEdited
                                                    ...
                                                    } transition-colors 2xl:text-base text-sm`}
                                            >
                                                Save Changes
                                            </button>
                                        </div>
                        ...
                        <div className="flex flex-col w-full h-full bg-[#2a2a2a]">
                            <div className="flex w-2/5 m-auto">
                                <div className="flex flex-col w-full bg-white bg-opacity-5 rounded-xl p-8">
                                    <h2 className="text-white 2xl:text-xl text-lg font-bold mb-6">Account Information</h2>

                                    <div className="space-y-4">
                                        <div className="flex flex-col space-y-1">
                                            <label className="text-white opacity-60 2xl:text-base text-sm">Email</label>
                                            <p className="text-white 2xl:text-base text-sm">{user.email}</p>
                                        </div>

                                        <div className="flex flex-col space-y-1">
                                            <label className="text-white opacity-60 2xl:text-base text-sm">Account Created</label>
                                        ...
                                        <div className="flex flex-col space-y-1">
                                            <label className="text-white opacity-60 2xl:text-base text-sm">Last Sign In</label>
                                            <p className="text-white 2xl:text-base text-sm">
                                        ...
                                        <div className="mt-8 pt-8 border-t border-white border-opacity-15">
                                            <h3 className="text-red-500 2xl:text-lg text-base font-semibold mb-4">Danger Zone</h3>
                                            ...
                                            <details className="group">
                                                <summary className="flex cursor-pointer items-center justify-between rounded-lg bg-red-500 bg-opacity-10 p-4 text-red-500">
                                                    <div className="flex items-center gap-2">
                                                        <span className="2xl:text-sm text-xs font-medium">Delete Account</span>
                                                    </div>
                                                ...
                                                <div className="mt-4 px-4 pb-4">
                                                    <p className="2xl:text-sm text-xs text-white opacity-60 mb-4">
                                                    ...
                                                    <div className="space-y-4">
                                                        <input
                                                            ...
                                                            className="w-full p-2 rounded bg-neutral-700 text-white border border-neutral-600 focus:border-red-500 focus:outline-none 2xl:text-base text-sm"
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-full bg-red-500 text-white py-2 rounded hover:bg-red-600 transition duration-300 2xl:text-base text-sm"
                                                        >
                                                            Delete Account
                                                        </button>
                                                    </div>
