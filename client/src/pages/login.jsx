                        ...
                        <div class="p-8 rounded-2xl bg-white bg-opacity-5">
                            ...
                            <form class="mt-8 space-y-4" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input name="password" type={showPassword ? "text" : "password"} required class="w-full bg-white bg-opacity-5 text-neutral-300 text-sm border border-white border-opacity-15 px-4 py-3 rounded-md focus:outline-none" placeholder="Enter password" />
